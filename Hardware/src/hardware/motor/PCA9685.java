...
public class PCA9685 {
	...
	private PCA9685() throws Exception{
		...
		//PWM 주파수를 50Hz로 설정(SG90 Servo Motor 가 50Hz에서 동작하기 때문)
		gpioProvider=new PCA9685GpioProvider(i2cBus, 0x40, new BigDecimal(50));
		//한 사이클당 시간(peroid) : 1초 / Frequency = 1/50 Hz =0.02s =20ms = 20000us
	...
	public static void main(String[] args) throws Exception {
		...
		pca9685.setStep(PWM_00, 164);Thread.sleep(2000);
		pca9685.setStep(PWM_00, 358);Thread.sleep(2000);
		pca9685.setStep(PWM_00, 552);Thread.sleep(2000);
