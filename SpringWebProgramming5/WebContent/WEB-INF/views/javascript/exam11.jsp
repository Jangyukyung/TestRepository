...
//			img.src="<%=application.getContextPath() %>/resources/image/photo04.jpg";

			var imgArray=document.querySelectorAll("img");
			for(var i=0;i<imgArray.length;i++){
				imgArray[i].src="<%=application.getContextPath() %>/resources/image/photo04.jpg";
			}
		}
		function handleBtn2(){
		...
		function handleBtn3(){
			...
			for(var i=0;i<class1.length;i++){
				class1[i].src="<%=application.getContextPath() %>/resources/image/photo06.jpg";
			}
		}
	</script>
    </head>
