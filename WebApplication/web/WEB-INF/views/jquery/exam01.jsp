...
<html>
	...
	<script>
		...
		function handleBtn2(){
			var img1=$("#img1");
			img1.attr("src","/WebApplication/resources/image/photo05.jpg";
		}
		function handleBtn3(){
			var class1=$(".class1");
			class1.attr("src","/WebApplication/resources/image/photo06.jpg";
		}
	</script>
    </head>
    <body>
		...
		<div>
			...
			<img id="img1" src="/WebApplication/resources/image/photo03.jpg" width="100px" height="100px"/>
